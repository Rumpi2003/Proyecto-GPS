...
export default function HomeAdmin() {
  ...
  const BadgeConteo = ({ cantidad }) => (
    <div className="bg-danger-low border border-danger/30 text-danger-hover px-6 py-1.5 rounded-full text-sm font-medium tracking-wide">
        ...
        <div className="bg-white rounded-panel shadow-soft p-6 md:p-10 flex flex-col gap-8 border border-slate-100 flex-grow">
          ...
          <div className="space-y-6 my-4">
            <div className="flex items-center gap-5">
              <div className="w-10 h-10 p-2.5 bg-ustay-bg rounded-xl flex items-center justify-center">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-5">
              <button 
                ...
                className="flex items-center justify-between w-full p-6 bg-transparent border border-ustay-blue/30 rounded-ustay-card hover:bg-ustay-card hover:shadow-soft transition-all duration-300 ease-in-out cursor-pointer group"
              >
                <div className="flex items-center gap-6">
                  ...
                  <span className="subtitulo">Solicitud de publicaciones</span>
                </div>
              ...
              >
                <div className="flex items-center gap-6">
                  ...
                  <span className="subtitulo">Reporte a publicaciones</span>
                </div>
              ...
              >
                <div className="flex items-center gap-6">
                  <div className="text-ustay-text">
                    <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24"><path d="M21 6h-2v9H6v2c0 .55.45 1 1 1h11l4 4V7c0-.55-.45-1-1-1zm-4 6V3c0-.55-.45-1-1-1H3c-.55 0-1 .45-1 1v14l4-4h10c.55 0 1-.45 1-1z"/></svg>
                  </div>
                  <span className="subtitulo">Reporte a comentarios</span>
                </div>
