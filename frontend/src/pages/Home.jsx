        ...
        <div className="lg:col-span-2 bg-white rounded-panel shadow-soft p-6 md:p-10 flex flex-col justify-between gap-8 border border-slate-100">
          ...
          <div className="space-y-3">
            ...
            <p className="texto max-w-2xl">
              Somos una comunidad dedicada a conectar estudiantes con opciones
              de alojamiento seguras, verificadas y a pasos de tu campus.
            </p>
          </div>
          ...
          <div className="space-y-6 my-4">
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <p className="texto max-w-2xl">
                  Todas las publicaciones son revisadas y aprobadas por
                  administradores para garantizar tu seguridad.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <p className="texto max-w-2xl">
                  Filtra por cercanía y encuentra alojamiento a minutos de tu
                  facultad, ya sea caminando o en transporte público.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <p className="texto max-w-2xl">
                  Lee comentarios y revisa las valoraciones reales de otros
                  estudiantes antes de tomar tu decisión.
                </p>
              </div>
            </div>
          </div>
